...
public class Eventables {
	...
	/* treeMap<function name, [[uniqueId,statevertex,eventable],[],...]> function name is the handler of the element and uniqueId is the id
	...
	/* function name is of type string, uniqueId is of type string, stateVertex is of type string, eventable is of type Eventable)>*/
